...
train_dataset = chat_dataset(
    csv_file="/home/username/Forever-Beta/train_processed.csv",
    tokenizer_file="tokenizer.json"
)

validation_dataset = chat_dataset(
    csv_file="/home/username/Forever-Beta/validation_processed.csv",
    tokenizer_file="tokenizer.json"
)

test_dataset = chat_dataset(
    csv_file="/home/username/Forever-Beta/test_processed.csv",
    tokenizer_file="tokenizer.json"
)
...
if __name__ =="main":
    ...
    best_val_acc = 0.0
    save_dir = "/home/username/Forever-Beta/checkpoints"
